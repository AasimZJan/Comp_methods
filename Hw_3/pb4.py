...
b=0.25                             #defining constants based on the example
c=5
...
###calling the methods(l is theta, m is omega, j is time. Similarly for other variables)
...
plt.legend()
plt.savefig("/Users/aj3008/Desktop/MS_3rd_Sem/Comp_methods_in_AST/Comp_methods/Hw_3/Latex/Images/pb4_1")
